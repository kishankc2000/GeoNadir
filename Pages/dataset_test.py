...
class DatasetUpload:
    ...
    def select_workspace(self, workspace):
        ...
        self.highlight_element(workspace_element)
    ...
    def select_dataset(self):
        ...
        self.highlight_element(dataset_element)
    ...
    def upload_dataset(self, folder_path):
        try:
            ...
            pyautogui.write(folder_path, interval=0.05)  # Slow down typing to ensure the full path is written
            time.sleep(10)
            ...
            self.highlight_element(continue_upload)
            ...
            self.highlight_element(checkbox_for_fairGeo_share)
            ...
            self.highlight_element(final_upload)
            final_upload.click()
            time.sleep(100)
            ...
            self.highlight_element(done_button)
            done_button.click()
        ...
        try:
            ...
            if dataset_card:
                ...
                try:
                    ...
                    self.highlight_element(browse_file)
                    browse_file.click()
                    time.sleep(5)
                ...
                self.highlight_element(upload_photos)
                upload_photos.click()
                time.sleep(5)
    ...
    def merge_dataset(self, folders_path):
        try:
            ...
            merge_into_single_set = self.driver.find_element(By.CSS_SELECTOR,
                                                             ".go-to-datasets.upload-clear-btn > img[alt='single-dataset']")
            self.highlight_element(merge_into_single_set)
